...
final class Event: ObservableObject {
    ...
    @Published var trackOrField : Int = 0
    ...
    var fieldCSV: Array<String> = ["TripleFirstRound.csv", "LongJumpFirstRound.csv", "HighJumpFirstRound.csv", "PoleVaultFirstRound.csv", "JavelinFirstRound.csv", "ShotPutFirstRound.csv", "DiscusFirstRound.csv", "HammerThrowFirstRound.csv"]
